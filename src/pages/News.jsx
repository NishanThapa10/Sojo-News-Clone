  ...
  return (
    <div className="mb-20 px-3">
      <div className="w-[60%] xsm:w-[100%] sm:w-[60%]">
        <h1 className="font-semibold text-3xl mb-[35px]" style={{color : darkMode? "white" : "black"}} >{news?.title}</h1>
        <div className="flex items-center gap-6">
          <img src={avatar} alt="avatar" className="w-[40px] h-[40px]" />
          <div>
            <p className="text-sm font-medium" style={{color : darkMode? "white" : "black"}}>Sojo News Team</p>
            <p className="text-xs text-gray-500" style={{color : darkMode? "white" : "black"}}>
        ...
        <img
          ...
          alt=""
        />
        <p className="mt-5" style={{color : darkMode? "white" : "black"}}>{news?.previewText}</p>

        <div className="bg-darkModebglight p-6 my-10 w-full rounded-lg">
          <h2 className="font-semibold mb-6" style={{color : darkMode? "white" : "black"}}>Share this story</h2>
      ...
      <h2 className="font-semibold text-2xl my-6" style={{color : darkMode? "white" : "black"}}>Similar Stories</h2>
